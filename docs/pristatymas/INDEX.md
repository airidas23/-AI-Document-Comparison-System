...
```mermaid
graph TB
    INDEX[📋 INDEX<br/>Jūs čia]
    
    FULL[📄 pristatymas_sistema.md<br/>Išsamus Pristatymas]
    SLIDES[🎯 pristatymas_slides.md<br/>Slide Deck]
    VISUAL[📊 santrauka_visual.md<br/>Visual Summary]
    DEMO[🎬 demo_scenarijus.md<br/>Demo Script]
...
```mermaid
timeline
    title Greitas Pasiruošimas Pristatymui
    
    section 20 min iki
        Perskaityti : pristatymas_slides.md
                    : Suprasti flow
        
    section 15 min iki
        Peržiūrėti : demo_scenarijus.md
                   : Practice scenarios
        
    section 10 min iki
        Patikrinti : Sistema veikia
                   : Demo files ready
        
    section 5 min iki
        Atidaryti : pristatymas_slides.md
                  : santrauka_visual.md
                  : demo_scenarijus.md
